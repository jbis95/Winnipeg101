...
const modalCloseBtn = modalContainer.querySelector('.close');
if (shareBtn) {
  ...
  if (statusOne.length) {
    commentsList.forEach(c => {
      if (c.status) {
        ...
        if (c.likeCount) {
          line += `<span class="dot"></span>`;
          line += `<span class="likeCount"><img src="/assets/empty.png">${c.likeCount}</span>`;
        }
        line += `</div>`;
        ...
        line += `<div class="left">`;
        line += `<div class="commentReply"><button id="commentReply">${lang.comment_reply}</button></div>`;
        line += `</div>`;
        line += `<div class="right">`;
        line += `<div class="likeBtn">`;
        if (c.userLike) {
          line += `<div class="commentLike"><button id="commentLike">${lang.comment_unlike}</button></div>`;
        } else {
          line += `<div class="commentLike"><button id="commentLike">${lang.comment_like}</button></div>`;
        }
        line += `</div>`;
        ...
        line += `<span class="nickName">${c.nickName}</span>`;
        line += `<span class="dot"></span>`;
        line += `<span class="permissionName">${c.permissionName}</span>`;
        line += `<span class="dot"></span>`;
        line += `<span class="datetime">${c.datetime}</span>`;
        if (c.likeCount) {
          line += `<span class="dot"></span>`;
